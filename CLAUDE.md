...
>
> Next up: rest of **Stage 7 — Polish & testing** (PWA + QR-scan testing on real Android & iOS). Before or during it, revisit "Known gaps and deferred decisions" below — its remaining IMPORTANT items (the live-update gaps) are natural candidates to fold into that stage's polish work.
>
